...
type ChatFunc func(context.Context, *gen.ChatMutation) (gen.Value, error)

// Mutate calls f(ctx, m).
func (f ChatFunc) Mutate(ctx context.Context, m gen.Mutation) (gen.Value, error) {
	if mv, ok := m.(*gen.ChatMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *gen.ChatMutation", m)
}

// The FailedJobFunc type is an adapter to allow the use of ordinary
// function as FailedJob mutator.
type FailedJobFunc func(context.Context, *gen.FailedJobMutation) (gen.Value, error)

// Mutate calls f(ctx, m).
func (f FailedJobFunc) Mutate(ctx context.Context, m gen.Mutation) (gen.Value, error) {
	if mv, ok := m.(*gen.FailedJobMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *gen.FailedJobMutation", m)
}
...
type ProblemFunc func(context.Context, *gen.ProblemMutation) (gen.Value, error)

// Mutate calls f(ctx, m).
func (f ProblemFunc) Mutate(ctx context.Context, m gen.Mutation) (gen.Value, error) {
	if mv, ok := m.(*gen.ProblemMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *gen.ProblemMutation", m)
}
