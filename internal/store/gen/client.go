...
import (
	...
	"github.com/ekhvalov/bank-chat-service/internal/store/gen/migrate"
...
func (c *FailedJobClient) mutate(ctx context.Context, m *FailedJobMutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("gen: unknown FailedJob mutation op: %q", m.Op())
	}
}
...
func (c *JobClient) mutate(ctx context.Context, m *JobMutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("gen: unknown Job mutation op: %q", m.Op())
	}
}
...
func (c *ProblemClient) mutate(ctx context.Context, m *ProblemMutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("gen: unknown Problem mutation op: %q", m.Op())
	}
}
