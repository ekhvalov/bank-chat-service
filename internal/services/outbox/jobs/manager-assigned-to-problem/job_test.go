...
import (
	...
	managerassignedtoproblemjobmocks "github.com/ekhvalov/bank-chat-service/internal/services/outbox/jobs/manager-assigned-to-problem/mocks"
...
func (s *JobSuite) SetupTest() {
	...
	var err error
	options := managerassignedtoproblemjob.NewOptions(s.messageRepo, s.problemRepo, s.managerLoad, s.eventStream, zap.NewNop())
...
func (s *JobSuite) TestHandle_InvalidOptionsError() {
	job, err := managerassignedtoproblemjob.New(managerassignedtoproblemjob.NewOptions(nil, nil, nil, nil, nil))
