...
func (mr *MockmessageProducerMockRecorder) ProduceMessage(ctx, message any) *messageProducerProduceMessageCall {
	...
	return &messageProducerProduceMessageCall{Call: call}
}

// messageProducerProduceMessageCall wrap *gomock.Call
type messageProducerProduceMessageCall struct {
	*gomock.Call
}

// Return rewrite *gomock.Call.Return
func (c *messageProducerProduceMessageCall) Return(arg0 error) *messageProducerProduceMessageCall {
	c.Call = c.Call.Return(arg0)
	return c
}

// Do rewrite *gomock.Call.Do
func (c *messageProducerProduceMessageCall) Do(f func(context.Context, msgproducer.Message) error) *messageProducerProduceMessageCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *messageProducerProduceMessageCall) DoAndReturn(f func(context.Context, msgproducer.Message) error) *messageProducerProduceMessageCall {
...
func (mr *MockmessagesRepositoryMockRecorder) GetMessageByID(ctx, msgID any) *messagesRepositoryGetMessageByIDCall {
	mr.mock.ctrl.T.Helper()
	...
	return &messagesRepositoryGetMessageByIDCall{Call: call}
}

// messagesRepositoryGetMessageByIDCall wrap *gomock.Call
type messagesRepositoryGetMessageByIDCall struct {
	*gomock.Call
}

// Return rewrite *gomock.Call.Return
func (c *messagesRepositoryGetMessageByIDCall) Return(arg0 *messagesrepo.Message, arg1 error) *messagesRepositoryGetMessageByIDCall {
	c.Call = c.Call.Return(arg0, arg1)
	return c
}

// Do rewrite *gomock.Call.Do
func (c *messagesRepositoryGetMessageByIDCall) Do(f func(context.Context, types.MessageID) (*messagesrepo.Message, error)) *messagesRepositoryGetMessageByIDCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *messagesRepositoryGetMessageByIDCall) DoAndReturn(f func(context.Context, types.MessageID) (*messagesrepo.Message, error)) *messagesRepositoryGetMessageByIDCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
