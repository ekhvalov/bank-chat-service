...
//
//	mockgen -source=job.go -destination=mocks/job_mock.gen.go -package=sendclientmessagejobmocks
//
...
func (mr *MockmessageProducerMockRecorder) ProduceMessage(ctx, message any) *gomock.Call {
